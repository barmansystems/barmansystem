                        ...
                        <tbody>
                            <tr>
                                <td class="text-center">
                                    <div class="mb-3">
                                        <span class="me-100">نام شخص حقیقی/حقوقی: بارمان سیستم سرزمین پارس</span>
                                        <span class="me-100">شماره اقتصادی: 10320471925</span>
                                        <span class="me-100">شماره ثبت/شماره ملی: 396431</span>
...
{{--                                            صنایع ماشین های اداری ماندگار پارس می باشد</strong></td>--}}
                                ...
                                <tr>
                                    <td colspan="6" id="seller_sign_sec">
                                        ...
                                        <img src="{{ asset('/assets/images/mohr-emza-barman.png') }}" class="stamp">
